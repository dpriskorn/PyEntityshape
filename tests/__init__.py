...
class TestEntityShape(TestCase):
    ...
    def test_get_result_valid(self):
        ...
        e.get_result()
        assert e.result != {}
        assert e.result["properties"] == {'P10': {'name': 'video', 'necessity': 'absent'},
                'P10242': {'name': 'Lur Encyclopedic Dictionary ID',
                           'necessity': 'absent'},
                'P10283': {'name': 'OpenAlex ID', 'necessity': 'absent'},
                'P1036': {'name': 'Dewey Decimal Classification',
                          'necessity': 'absent'},
                'P1051': {'name': 'PSH ID', 'necessity': 'absent'},
                'P10757': {'name': 'Personality Database profile ID',
                           'necessity': 'absent'},
                'P11196': {'name': 'Baidu Tieba name', 'necessity': 'absent'},
                'P11408': {'name': 'Pixiv Encyclopedia ID',
                           'necessity': 'absent'},
                'P1245': {'name': 'OmegaWiki Defined Meaning',
                          'necessity': 'absent'},
                'P1256': {'name': 'Iconclass notation', 'necessity': 'absent'},
                'P1296': {'name': 'Gran Enciclopèdia Catalana ID',
                          'necessity': 'absent'},
                'P1343': {'name': 'described by source', 'necessity': 'absent'},
                'P1417': {'name': 'Encyclopædia Britannica Online ID',
                          'necessity': 'absent'},
                'P1419': {'name': 'shape', 'necessity': 'absent'},
                'P1424': {'name': "topic's main template",
                          'necessity': 'absent'},
                ...
                'P1711': {'name': 'British Museum person or institution ID',
                          'necessity': 'absent'},
                ...
                'P244': {'name': 'Library of Congress authority ID',
                         'necessity': 'absent'},
                'P2579': {'name': 'studied by', 'necessity': 'absent'},
                'P2581': {'name': 'BabelNet ID', 'necessity': 'absent'},
                'P2612': {'name': 'TED topic ID', 'necessity': 'absent'},
                'P2670': {'name': 'has part(s) of the class',
                          'necessity': 'absent'},
                'P268': {'name': 'Bibliothèque nationale de France ID',
                         'necessity': 'absent'},
                'P2924': {'name': 'Great Russian Encyclopedia Online ID (old '
                                  'version)',
                          'necessity': 'absent'},
                'P31': {'name': 'instance of', 'necessity': 'absent'},
                'P3113': {'name': 'does not have part', 'necessity': 'absent'},
                'P3219': {'name': 'Encyclopædia Universalis ID',
                          'necessity': 'absent'},
                ...
                'P3569': {'name': 'Cultureel Woordenboek ID',
                          'necessity': 'absent'},
                'P361': {'name': 'part of', 'necessity': 'absent'},
                'P373': {'name': 'Commons category', 'necessity': 'absent'},
                'P3847': {'name': 'Open Library subject ID',
                          'necessity': 'absent'},
                'P3916': {'name': 'UNESCO Thesaurus ID', 'necessity': 'absent'},
                'P3938': {'name': 'named by', 'necessity': 'absent'},
                'P4342': {'name': 'Store norske leksikon ID',
                          'necessity': 'absent'},
                'P443': {'name': 'pronunciation audio', 'necessity': 'absent'},
                'P461': {'name': 'opposite of', 'necessity': 'absent'},
                'P4613': {'name': 'Encyclopedia of Modern Ukraine ID',
                          'necessity': 'absent'},
                'P5008': {'name': 'on focus list of Wikimedia project',
                          'necessity': 'absent'},
                'P5019': {'name': 'Brockhaus Enzyklopädie online ID',
                          'necessity': 'absent'},
                'P5034': {'name': 'National Library of Korea ID',
                          'necessity': 'absent'},
                'P508': {'name': 'BNCF Thesaurus ID', 'necessity': 'absent'},
                'P527': {'name': 'has part(s)', 'necessity': 'absent'},
                'P5337': {'name': 'Google News topics ID',
                          'necessity': 'absent'},
                'P5357': {'name': 'The Encyclopedia of Science Fiction ID',
                          'necessity': 'absent'},
                ...
                'P7033': {'name': 'Australian Educational Vocabulary ID',
                          'necessity': 'absent'},
                'P7305': {'name': 'Online PWN Encyclopedia ID',
                          'necessity': 'absent'},
                'P7314': {'name': 'TDV İslam Ansiklopedisi ID',
                          'necessity': 'absent'},
                ...
                'P8189': {'name': 'National Library of Israel J9U ID',
                          'necessity': 'absent'},
