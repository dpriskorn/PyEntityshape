...
class TestResult(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.campsite_not_allowed_P625_result = Result(
            **self.campsite_not_allowed_P625
        )
    ...
    def test__find_properties_with_not_enough_correct_statements__(self):
        assert len(self.campsite_missing_correct_p31_result.properties_without_enough_correct_statements) == 1

    def test__find_statements_with_property_that_is_not_allowed__(self):
        assert len(self.campsite_not_allowed_P625_result.statements_with_property_that_is_not_allowed) == 1